 ...
 */
@Slf4j
public class DiditechSentinelInvocationHandler implements InvocationHandler {
	...
	DiditechSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			DiditechSentinelInvocationHandler other = (DiditechSentinelInvocationHandler) obj;
