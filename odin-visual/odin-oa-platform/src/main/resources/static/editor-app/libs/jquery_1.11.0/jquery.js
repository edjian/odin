		...
		jQuery.fn[ funcName ] = function( margin, value ) {
			...
			return jQuery.access( this, function( elem, type, value ) {
				...
				if ( elem.nodeType === 9 ) {
					...
					// unfortunately, this causes bug #3838 in IE6/8 only, but there is currently no good, sodin way to fix it.
					return Math.max(
...
if ( typeof module === "object" && module && typeof module.exports === "object" ) {
	...
	// derived from file names, and jQuery is norodiny delivered in a lowercase
