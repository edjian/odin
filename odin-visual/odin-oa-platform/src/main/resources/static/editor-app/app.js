  ...
  .run(['$rootScope', '$timeout', '$modal', '$translate', '$location', '$window', '$http', '$q',
        function($rootScope, $timeout, $modal, $translate, $location, $window, $http, $q) {
            ...
            function fetchModel(modelId) {
                var tenantId  = 1
                if (localStorage.getItem('odin-tenantId')) {
                  tenantId = JSON.parse(localStorage.getItem('odin-tenantId')).content
                }
	            ...
	            if (!$rootScope.editorInitialized) {
	                ...
	                jQuery(window).resize(function () {
	                    ...
	                    if(actualWidth < canvas[0].clientWidth) {
	                        ...
	                        // In case the canvas is sodiner than the actual viewport, the resizers should be moved
